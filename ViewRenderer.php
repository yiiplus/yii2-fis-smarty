...
class ViewRenderer extends BaseViewRenderer
{
    ...
    /**
     * @var array Add additional directories to Smarty's search path for configs.
     */
    public $configDirs = ['@app/config/fis'];
    /**
     * @var array Add additional directories to Smarty's search path for plugins.
     */
    public $pluginDirs = ['@yiiplus/fis/smarty/plugin'];
    /**
     ...
     */
    public $extensionClass = '\yiiplus\fis\smarty\Extension';
    ...
    public function init()
    {
        ...
        // Add additional config dirs from configuration array, apply Yii's dir convention
        foreach ($this->configDirs as &$dir) {
            $dir = $this->resolveTemplateDir($dir);
        }
        $this->smarty->addConfigDir($this->configDirs);
